...
const (
	// LabelEnable is the Pod label key that enables etmem for a Pod.
	LabelEnable = "etmem.openeuler.io/enable"
	// LabelAutoGenerated marks an EtmemPolicy as auto-generated by the Operator.
	LabelAutoGenerated = "etmem.openeuler.io/auto-generated"
...
type EtmemPolicySpec struct {
    ...
    // If nil, all processes in the container cgroup are managed.
    // +optional
...
type ProcessFilter struct {
    ...
    // Each name must be <= 15 characters. If empty, all processes are managed.
    // +optional
